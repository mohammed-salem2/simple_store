                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                        <div class="ps-checkout__billing">
                            ...
                            <div class="form-group form-group--inline">
                                <x-input-form name="billing_name" :label="__('Name')" />
                            </div>
                            <div class="form-group form-group--inline">
                                <x-input-form name="billing_email" type="email" :label="__('Email Address')" />
                            </div>
                            <div class="form-group form-group--inline">
                                <x-input-form name="billing_phone" :label="__('Phone')" />
                            </div>
                            <div class="form-group form-group--inline">
                                <x-input-form name="billing_address" :label="__('address')" />
                            </div>
                            <div class="form-group form-group--inline">
                                <x-input-form name="billing_city" :label="__('City')" />
                            </div>
                            <div class="form-group form-group--inline">
                                <label for="country">{{ __('Choose Country') }}</label>
                                <select class="custom-select form-control-border @error('country')
                                is-invalid
                                @enderror" id="country" name="billing_country">
