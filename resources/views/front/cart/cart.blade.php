            ...
            <div class="ps-cart-listing">
                        ...
                        @foreach ($cart as $item)
                            <tr>
                                <td><a class="ps-product__preview"
                                        href="{{ route('products.details', $item->product->slug) }}"><img class="mr-15"
                                            width="90" src="{{ $item->product->image_url }}" alt="">
                ...
                <div class="ps-cart__actions">
                    ...
                    <div class="ps-cart__total">
                        ...
                        <a class="ps-btn" href="{{ route('checkout') }}">Process to checkout<i
