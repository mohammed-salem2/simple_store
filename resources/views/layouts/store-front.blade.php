...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('front/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css') }}">
    <link rel="stylesheet" href="{{ asset('front/plugins/slick/slick/slick.css') }}">
    <link rel="stylesheet"
        href="{{ asset('front/plugins/bootstrap-select/dist/css/bootstrap-select.min.css') }}">
...
<body class="ps-loading">
                        ...
                        <div class="header__actions"><a href="#">Login & Regiser</a>
                            <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#"><img src="{{ asset('front/images/flag/usa.svg') }}"
                                                alt=""> USD</a></li>
                                    <li><a href="#"><img
                                                src="{{ asset('front/images/flag/singapore.svg') }}"
                                                alt=""> SGD</a></li>
                                    <li><a href="#"><img src="{{ asset('front/images/flag/japan.svg') }}"
                                                alt=""> JPN</a></li>
                                </ul>
                            </div>
                            <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#"
    ...
    <main class="ps-main">
        ...
        <div class="ps-footer bg--cover" data-background="{{ asset('front/images/background/parallax.jpg') }}">
    ...
    <script type="text/javascript" src="{{ asset('front/plugins/revolution/js/jquery.themepunch.tools.min.js') }}">
    </script>
    <script type="text/javascript"
    ...
    <script type="text/javascript"
        src="{{ asset('front/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}">
    </script>
    <script type="text/javascript"
    ...
    <script type="text/javascript" src="{{ asset('front/js/cart.js') }}"></script>
</body>
