                        ...
                        <div class="card mb-4">
                            <div class="card-body bg-white">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">{{ $categories->name }}</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">{{ $categories->parent_name ?? "Not Found" }}</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">{{ $categories->status }}</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">{{ $categories->description }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
